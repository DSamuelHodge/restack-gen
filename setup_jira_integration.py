...
def verify_base64_encoding(jira_env):
    ...
    if provided_base64 == expected_base64:
        ...
        print("   (This combines your email and API token, not a separate credential)")
        return False
...
def show_github_secrets_setup():
    ...
    secrets = [
        ...
        (
            "JIRA_AUTH_TOKEN_BASE64",
            jira_env.get("JIRA_AUTH_TOKEN_BASE64", "YOUR_BASE64_ENCODED_TOKEN_HERE"),
        ),
