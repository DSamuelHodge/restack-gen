...
class TestToolServerGeneration:
    ...
    def test_generate_tool_server_creates_files(self, temp_project):
    ...
    def test_generate_tool_server_content(self, temp_project):
    ...
    def test_generate_tool_server_snake_case_input(self, temp_project):
    ...
    def test_generate_tool_server_pascal_case_input(self, temp_project):
    ...
    def test_generate_tool_server_without_project_fails(self, tmp_path, monkeypatch):
    ...
    def test_generate_tool_server_invalid_name(self, temp_project):
    ...
    def test_generated_tool_server_is_valid_python(self, temp_project):
    ...
    def test_tool_server_has_health_check(self, temp_project):
    ...
    def test_tool_server_has_run_method(self, temp_project):
    ...
    def test_tool_server_has_main_block(self, temp_project):
    ...
    def test_multiple_tool_servers(self, temp_project):
